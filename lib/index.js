...
var MonthViewCalendar = /** @class */ (function (_super) {
    ...
    function MonthViewCalendar(props) {
        ...
        _this.scrollEnd = function (event) {
            ...
            previousIndex != newIndex &&
                onSwipe &&
                onSwipe(datesList[_this.currentPageIndex]);
    ...
    MonthViewCalendar.prototype.renderWeekCalendar = function (date) {
        ...
        return days.map(function (week, i) { return (react_1.default.createElement(calendarRow_1.default, { key: "week-".concat(i), borderColor: _this.props.borderCellColor }, week.map(function (day, j) {
            var eventsOfDay = (0, utils_1.findEventsForTheDay)(day, _this.props.events);
            return (react_1.default.createElement(calendarDay_1.default, { key: j, index: j, date: day, events: eventsOfDay, renderEvent: _this.props.renderEvent, textStyles: _this.props.dayTextStyles, borderCellColor: _this.props.borderCellColor }));
        }))); });
    };
    MonthViewCalendar.prototype.render = function () {
        var _this = this;
        var _a = this.props, weekDays = _a.weekDays, headerTextStyles = _a.headerTextStyles, backgroundColorContent = _a.backgroundColorContent, backgroundColorHeader = _a.backgroundColorHeader;
        return (react_1.default.createElement(react_native_1.View, { style: [
                styles.calendarContainer,
                { backgroundColor: backgroundColorContent },
            ] },
            react_1.default.createElement(react_native_1.VirtualizedList, { ref: this.setRefOfMonthVirtualList, keyExtractor: function (item) { return item; }, data: this.state.datesList, getItemCount: function (data) { return data.length; }, getItem: function (data, index) { return data[index]; }, initialScrollIndex: 0, horizontal: true, renderItem: function (_a) {
                    var item = _a.item;
                    return (react_1.default.createElement(react_native_1.View, { style: { width: utils_1.CONTAINER_WIDTH } },
                        react_1.default.createElement(calendarHeader_1.default, { weekDays: weekDays, textStyles: headerTextStyles, backgroundColorHeader: backgroundColorHeader }),
                        react_1.default.createElement(react_native_1.View, { style: styles.monthViewExceptHeader }, _this.renderWeekCalendar(item))));
...
var styles = react_native_1.StyleSheet.create({
    monthViewExceptHeader: { width: utils_1.CONTAINER_WIDTH, flex: 1 },
    calendarContainer: {
        width: "100%",
        height: "100%",
