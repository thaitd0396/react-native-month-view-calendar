...
var MonthViewCalendar = /** @class */ (function (_super) {
    ...
    MonthViewCalendar.prototype.render = function () {
        var _this = this;
        var _a = this.props, weekDays = _a.weekDays, headerTextStyles = _a.headerTextStyles, containerStyle = _a.containerStyle;
        return (react_1.default.createElement(react_native_1.View, { style: [styles.calendarContainer, containerStyle] },
